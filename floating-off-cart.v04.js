(function () {
    ...
    set (target, key, newValue, receiver) {
      ...
      switch (key) {
        ...
        case 'basePromo':
          ...
          validMessage.classList.toggle(GENERAL_HIDDEN_CLASS, basePromo === null || isFreebieOffer)
        ...
        case 'isFreebieOffer':
          {
            validMessageImage.classList.toggle(GENERAL_HIDDEN_CLASS, !newValue)
  ...
  const MOProduct = new MutationObserver(function (mutations, observer) {
    ecommerceItems.element && formMutations.observe(ecommerceItems.element, {
      childList: true
    })
