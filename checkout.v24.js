  ...
  const IYSCheckoutApp = createApp({
    ...
    computed: {
      ...
      isShippingAddressFieldsRequired () {
        return this.showShippingAddressSelector && !this.isSameAddress
      },
      ...
      billingAddressResume () {
        ...
        const textAddress = `${address.zipPostalCode} ${address.street}, ${address.number} - ${address.neighbourhood} - ${address.city}/${address.state}`
