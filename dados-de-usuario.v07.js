(function () {
   ...
   * @returns           {Promise<IGetUserResponse<XanoPreconditionFailed>>}
   */
  async function updateUser (userDetails) {
    try {
      ...
      if (!response.ok) {
        /** @type {XanoPreconditionFailed<null>} */
        const error = await response.json()

        throw new Error(error.message || 'Falha ao salvar os dados')
      }
  ...
  function validateNameField () {
    ...
    toggleClass(nameUpdateFieldWrapper, ERROR_MESSAGE_CLASS, !isValidField)
  ...
  function validateCPFField () {
    ...
    toggleClass(cpfUpdateFieldWrapper, ERROR_MESSAGE_CLASS, !isFieldValid)
  ...
  function validatePhoneField () {
    ...
    toggleClass(phoneUpdateFieldWrapper, ERROR_MESSAGE_CLASS, !isFieldValid)
  ...
  function validateBirthdayField () {
    ...
    toggleClass(birthdayUpdateFieldWrapper, ERROR_MESSAGE_CLASS, !isValidDate)
  ...
  const _updateUserForm = querySelector('#id-form-update-user-data')
  ...
  const errorMessage = querySelector('[data-wtf-user-update-error-message]')
  const successMessage = querySelector('[data-wtf-user-update-success-message]')
   ...
   */
  function handleMessages (isError, message = 'Falha ao salvar os dados') {
    if (isError) {
      removeClass(errorMessage, GENERAL_HIDDEN_CLASS)

      querySelector('div', errorMessage).textContent = message

      return
    }

    removeClass(successMessage, GENERAL_HIDDEN_CLASS)
  }
  ...
  attachEvent(toggleUpdateUserForm, 'click', function (e) {
    ...
    toggleClass(updateUserGroup, GENERAL_HIDDEN_CLASS)
  }, false)
  ...
  attachEvent(cpfUpdateField, 'input', function (e) {
    removeClass(cpfUpdateFieldWrapper, ERROR_MESSAGE_CLASS)
  ...
  attachEvent(birthdayUpdateField, 'input', function (e) {
    removeClass(birthdayUpdateFieldWrapper, ERROR_MESSAGE_CLASS)
  ...
  attachEvent(phoneUpdateField, 'input', function (e) {
    removeClass(phoneUpdateFieldWrapper, ERROR_MESSAGE_CLASS)
  ...
  attachEvent(updateUserForm, 'submit', async function (e) {
    ...
    updateUser({
      ...
      .then(({ error, data }) => {
        ...
        handleMessages(error, data?.message)
      })
