(function () {
  ...
  attachEvent(quantityInput, 'input', () => {
  ...
  attachEvent(calcCEPField, 'input', function (e) {
    ...
    setCookie('cep-destino', numberOnly(e.target.value), {
      path: '/',
      secure: true,
      sameSite: 'None',
    ...
    handleShippingPrice().then(handlerCEP)
  })
  ...
  async function handlerCEP () {
    ...
    renderFinalPrice(shippingCostElement, 0)
