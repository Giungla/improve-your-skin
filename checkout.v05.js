...
(function () {
  ...
  const IYSCheckoutApp = createApp({
    ...
    computed: {
       ...
       */
      vuelidate () {
        console.log(this.countSubmissionTries, 'submission try')
      ...
      async handleProcessCreditCard () {
        try {
          ...
          if (!response.ok) {
            ...
            console.log('[creditCardError]', error)
