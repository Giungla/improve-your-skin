(function () {
  ...
  async function getGoogleAuthorizationURL () {
    const url = new URL('https://xef5-44zo-gegm.b2.xano.io/api:xEr0JVKx/oauth/google/init')
  ...
  const previousSibling = loginForm.previousElementSibling

  loginForm.remove()

  previousSibling.insertAdjacentHTML('afterend', loginForm.outerHTML)
