(function() {
  ...
  function startConsentModule () {
    consentModule.classList.remove('oculto')
    ...
    attachEvent(querySelector('[data-wtf-consent-module-accept]'), 'click', function (e) {
      ...
      consentModule.classList.add('oculto')
    })
  ...
  const openConsentDialog = querySelector('[data-wtf-consent-open]')

  if (!openConsentDialog) return

  attachEvent(openConsentDialog, 'click', function (e) {
    e.preventDefault()
    e.stopPropagation()
